...
const steps = [
  {
    ...
    desc: "We accept all major file types including JPG, PNG, GIF, WEBP, HEIC, TIFF, PDF, and more. Simply upload your design.",
    icon: CloudUpload,
  },
  {
    title: "STEP 2",
    heading: "Our designers get to work",
    desc: "Using the latest design software, our experts manually trace each file to ensure clean, high-quality results tailored to your needs.",
    icon: ChevronDown,
  },
  {
    title: "STEP 3",
    heading: "Approve & make payment",
    desc: "Once you're happy with the preview, pay securely via PayPal, Wise, or bank transfer—simple and safe.",
    icon: CheckCircle,
  },
  {
    title: "STEP 4",
    heading: "You've got a vector file!",
    desc: "We’ll email you the final files in your requested format: EPS, AI, SVG, PDF, PNG, and more—ready for print or stitch.",
    icon: Mail,
  },
];
