        ...
        <div className="md:col-span-1 space-y-6 bg-indigo-100 p-6 rounded-xl">
          ...
          <div className="space-y-4">
            <div className="flex items-center space-x-3">
              ...
              <span className="text-gray-800 text-sm">ditizingkart@gmail.com</span>
            </div>
            <div className="flex items-center space-x-3">
            ...
            <div className="flex items-center space-x-3">
              ...
              <span className="text-gray-800 text-sm">careers@ditizingkart.com</span>
            </div>
          </div>
          <h3 className="text-xl font-bold mt-6">Corporate Office</h3>
          <p className="text-gray-700 text-sm">
            DITIZING KART PVT LTD
          ...
          <div className="flex items-center space-x-3">
            ...
            <span className="text-gray-800 text-sm">+91 9876543210 / +91 9876543211</span>
          </div>
        </div>

        {/* Form Panel */}
        <div className="md:col-span-2 p-6 space-y-6 bg-white rounded-xl shadow-md">
          <h2 className="text-3xl font-bold text-center text-gray-900">Hi, How can Ditizing Kart help you?</h2>
          <p className="text-gray-700 text-center text-sm">
            Have a question or need support? Send us a message and our team will get back to you soon.
          </p>
